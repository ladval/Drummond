...
Local $aReporteData[2][10]
$aReporteData[0][
0] = "LOTE"$aReporteData[0][
1] = "SERVICIO"$aReporteData[0][
2] = "INVOICE "$aReporteData[0][
3] = "INVOICE DATE"$aReporteData[0][
4] = "CIF US $"$aReporteData[0][
5] = "TCRM"$aReporteData[0][
6] = "CIF COP $"$aReporteData[0][
7] = "MANEJO NAVIERO"$aReporteData[0][
8] = "USO INSTALACIONES"$aReporteData[0][
9] = "BODEGAJE"
