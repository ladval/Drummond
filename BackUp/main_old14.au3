...
Local $sCosteoDrummondQuery = "SELECT DISTINCT * FROM Repecev2005.dbo.VCosteoDrummond_fact WHERE FACTURASERVICIOS='"&$sSQL_InvoiceNumber&"'"
Local $sJsonFactQuery = "SELECT JsonFact FROM [BotAbc].[dbo].[tfact_ApiProcesos] where iNVOICEnUMBER = '"&$sSQL_InvoiceNumbers&"'"
