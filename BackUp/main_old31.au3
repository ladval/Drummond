...
Func _2dArray_UniqueElements()
Local $aArrayUnique = _ArrayUnique($aArray, 0, 1, Default, 0) ;Configuración que permite seleccionar únicamente la información no repetida de la tabla sin header ni COUNT
